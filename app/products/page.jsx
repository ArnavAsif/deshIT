  ...
  return (
    <div>
      ...
      <div className="bg-[#FDF8F8] pt-[100px] pb-[60px] md:pt-[158px] md:pb-[113px] text-center">
        <AnimatedHeading text="Our Products" />
        <p className="text-[15px]">
          Home <span className="text-[#646464]">{">"} Our Products</span>
        </p>
      </div>

      {/* Projects grid */}
      <motion.div
        className="max-w-7xl flex flex-col md:flex-row flex-wrap gap-[30px] justify-center items-center mx-auto px-4 md:px-0 mt-10 md:mt-[83px]"
